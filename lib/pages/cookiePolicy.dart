...
//large screen
class WideCookiePage extends StatefulWidget {
  const WideCookiePage({Key key}) : super(key: key);

  @override
  _WideCookiePageState createState() => _WideCookiePageState();
}

class _WideCookiePageState extends State<WideCookiePage> {
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                constraints:
                                    BoxConstraints(maxWidth: 1920 / 1.4),
                                child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  TableRow(children: [
                                                    ...
                                                    Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Used to maintain an anonymous user session by the server in Node Js ( Express ) Web Application. It is a necessary cookie that expires in 4days',
                                                            style: TextStyle(
                                                                color: Colors
                                                                    .black,
                                                                fontFamily:
