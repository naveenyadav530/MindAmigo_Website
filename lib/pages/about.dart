...
class wideAbout extends StatefulWidget {
  const wideAbout({Key key}) : super(key: key);

  @override
  _wideAboutState createState() => _wideAboutState();
}

class _wideAboutState extends State<wideAbout> {
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontFamily: robot,
                                      fontSize:
                                          2.08 * SizeConfig.textMultiplier),
                                ),
                              ),
                              //left circle
                              CircleAmigo(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        CircleAmigo(
                          ...
                          circleAmigoHeight:
                              22.27 * SizeConfig.heightMultiplier,
                          circleAmigoGradient: [
                            AmigoColors.orange,
                            AmigoColors.lightRed2
                          ],
