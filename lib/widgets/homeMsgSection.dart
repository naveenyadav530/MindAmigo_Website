        ...
        children: [
          Positioned(
            ...
            child: Text(
              sectionText,
              style:
                  TextStyle(color: sectionTextColor, fontSize: sectionFontSize),
            ),
          ),
          Positioned(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Image.asset(
            image,
            height: 30.25 * SizeConfig.heightMultiplier,
            width: 30.25 * SizeConfig.heightMultiplier,
          ),
          Padding(
            padding: EdgeInsets.symmetric(
                vertical: 1.51 * SizeConfig.heightMultiplier),
            child: Text(
              sectionText,
...
class WideHomeSection extends StatelessWidget {
  final Color sectionColor;
  final Alignment sectionAlign;
  final double sectionPositionLeft;
  final double sectionPositionRight;
