      ...
      child: Stack(
        ...
        children: [
          Positioned(
            ...
            child: Text("Download the mindamigo app", style: TextStyle(color: Colors.white, fontSize: 2.4*SizeConfig.textMultiplier, fontWeight: FontWeight.bold),)
          ),
          Positioned(
              left: 14.97*SizeConfig.heightMultiplier,
          ...
          Positioned(
              ...
              child: Text("support@mindamigo.com", style: TextStyle(color: Colors.white, fontSize: 1.10*SizeConfig.textMultiplier, fontWeight: FontWeight.bold),)
          ),
          Positioned(
              left: 26.04*SizeConfig.heightMultiplier,
          ...
          Positioned(
              ...
              child: Text("c 2020 Mindamigo", style: TextStyle(fontSize: 1.10*SizeConfig.textMultiplier, fontWeight: FontWeight.bold, color: Colors.white),)
          ),
          Positioned(
              left: 26.04*SizeConfig.heightMultiplier,
              bottom: 3.2*SizeConfig.heightMultiplier,
