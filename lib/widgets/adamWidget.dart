              ...
              children: [
                Container(
                    margin: EdgeInsets.only(
                        top: 3.55 * SizeConfig.heightMultiplier),
                    child: CircleAvatar(
                ...
                Container(
                  width: MediaQuery.of(context).size.width / 1.5,
                  margin:
                      EdgeInsets.only(top: 3.90 * SizeConfig.heightMultiplier),
                  child: Text(
                    Strings.adamTitle,
                    textAlign: TextAlign.center,
                    style: TextStyle(
                ...
                Container(
                  margin:
                      EdgeInsets.only(top: 1.30 * SizeConfig.heightMultiplier),
                  width: MediaQuery.of(context).size.width / 1.4,
                  child: Text(
                    Strings.adamPara,
                    textAlign: TextAlign.center,
                ...
                SizedBox(
                  height: 4.25 * SizeConfig.heightMultiplier,
                )
              ],
            ),
          ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style:
                        TextStyle(fontSize: 1.62 * SizeConfig.textMultiplier),
                  ),
                ),
                SizedBox(
                  height: 4.25 * SizeConfig.heightMultiplier,
